//priorites array 내가 요청한 문서의 대기목록 위치
priorities1 = [1, 2, 3, 4];
location1 = 2;
...
function solution(priorities, location) {
  ...
  //1. priorites를 Queue로 형변환 하는 방법
  for (const print of priorities) {
    //2. 나머지 인쇄목록 중 max인지 확인하는 함수(check max element of array)
  }
  printQueue.dequeue();
  return console.log(printQueue);
}
